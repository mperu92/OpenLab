    ...
    public class OpenLabDbContext : IdentityDbContext<IdentityUserModel, IdentityRoleModel, int, IdentityUserClaim<int>, IdentityUserRoleModel, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            if (modelBuilder != null)
            {
                ...
                modelBuilder.Entity<IdentityUserRoleModel>(b => b.ToTable("OpenLab_UsersRoles"));

                modelBuilder.Entity<IdentityRoleClaim<int>>(b => b.ToTable("OpenLab_RoleClaims"));

                modelBuilder.Entity<IdentityUserClaim<int>>(b => b.ToTable("OpenLab_UserClaims"));

                modelBuilder.Entity<IdentityUserLogin<int>>(b => b.ToTable("OpenLab_UserLogins"));
